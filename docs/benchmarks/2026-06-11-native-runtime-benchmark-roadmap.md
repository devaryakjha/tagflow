...
- Memory/allocation: GC counts are captured in profile summaries, and a bounded
  ...
  Same-process retained-path samples now exist for both authored-insertion
  lanes, and paired raw VM-service heap snapshot/class-diff evidence is now
  recorded in
  [`docs/benchmarks/baselines/2026-06-12-authored-insertion-raw-heap-diff-evidence.md`](baselines/2026-06-12-authored-insertion-raw-heap-diff-evidence.md).
  The `tagflow:large_article` lane now also has same-process raw VM-service
  heap snapshot/class-diff evidence recorded in
  [`docs/benchmarks/baselines/2026-06-12-large-article-raw-heap-diff-evidence.md`](baselines/2026-06-12-large-article-raw-heap-diff-evidence.md).
