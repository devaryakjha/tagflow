...
void main(List<String> args) {
  ...
  final fixtures = options.fixtureIds?.map(fixtureById).toList(growable: false);

  final suite = TagflowParserBenchmarkSuite(
  ...
  if (options.outputPath != null) {
    ...
    stdout.writeln('Wrote parser benchmark results to ${outputFile.path}');
  }
